...
**YOU ARE IN: `htmltweak/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/htmltweak/` (rig root) or other directories
...
**Your mail address:** `htmltweak/polecats/rust`
**Your rig:** htmltweak
**Your Witness:** `htmltweak/witness`
...
| Ask Witness for help | `gt mail send htmltweak/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`htmltweak/witness`) when:
...
```bash
gt mail send htmltweak/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
